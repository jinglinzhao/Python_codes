...
def fit_data(star,fitting_function):
    ...
    # popt,pcov = curve_fit(fitting_function, star.t, star.vr, sigma=star.vr_err, absolute_sigma=True, p0=initial_guess)
    popt,pcov = curve_fit(fitting_function, star.t, star.vr, sigma=star.vr_err, p0=initial_guess)
