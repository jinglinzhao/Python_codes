...
plt.text(min(G), 0.9*y_up+0.1*y_lo, r'$\rho$={0:.2f}±{1:.2f}'.format(r1,delta_r), fontsize=fontsize)
...
delta_r = (1-r1**2)/(N-2)**0.5
plt.text(-1.1+0.1*2.2, 0.9*y_up+0.1*y_lo, r'$\rho$={0:.2f}±{1:.2f}'.format(r1,delta_r), fontsize=fontsize)
