...
shutil.copy('HD7449.py', '../output/'+dir_name+'/HD7449.py')  
...
if star == 'HD7449':
    kernel      = kernels.ConstantKernel(log_constant=np.log(1.0), bounds=dict(log_constant=(-3,4))) * kernels.ExpSquaredKernel(10**2.)
